# @xfos/frontend-platform-admin

Platform Admin. Port **3003**. Self-contained (see docs §12).

```bash
pnpm --filter @xfos/frontend-platform-admin dev          # → http://localhost:3003
pnpm --filter @xfos/frontend-platform-admin build:tokens # regenerate design tokens
pnpm --filter @xfos/frontend-platform-admin test         # vitest
```
