        ...
        patterns: [
          {
            ...
            message:
              'Each frontend app is self-contained. Only import from `@xfos/contracts-bff-platform-admin` and `@xfos/contracts-enums`.',
          },
          {
          ...
          },
          {
            ...
            message:
              'Frontend apps cannot import domain contracts or sibling BFF contracts. Use @xfos/contracts-bff-platform-admin.',
          },
        ],
      },
    ],
