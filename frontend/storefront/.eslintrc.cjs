        ...
        patterns: [
          {
            ...
            message:
              'Each frontend app is self-contained. Only import from `@xfos/contracts-bff-storefront` and `@xfos/contracts-enums`.',
          },
          {
          ...
          {
            // Rule 4 — BFF-only contracts. Frontends never see raw domain shapes.
            // See ADR-008. The storefront frontend may import only:
            //   - @xfos/contracts-enums (shared enums)
            //   - @xfos/contracts-bff-storefront (its BFF projection)
            group: [
              ...
              '@xfos/contracts-bff-admin',
              '@xfos/contracts-bff-platform-admin',
            ],
            message:
              'Frontend apps cannot import domain contracts or sibling BFF contracts. Use @xfos/contracts-bff-storefront — your BFF projects what you need.',
          },
        ],
      },
    ],
